...
class EnderecosControllerTest < ActionController::TestCase
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post :create, endereco: { cep: @endereco.cep, complemento: @endereco.complemento, logradouro: @endereco.logradouro, numero: @endereco.numero, tipo_logradouro: @endereco.tipo_logradouro }
    end
  ...
  test "should update endereco" do
    patch :update, id: @endereco, endereco: { cep: @endereco.cep, complemento: @endereco.complemento, logradouro: @endereco.logradouro, numero: @endereco.numero, tipo_logradouro: @endereco.tipo_logradouro }
    assert_redirected_to endereco_path(assigns(:endereco))
  end
